...
ASSEMBLER_TEST_RUN(ReadArgument, test) {
  ...
  EXPECT_DISASSEMBLY_NOT_WINDOWS("push rdi\n"
                                 "movq rax,[rsp]\n"
                                 "pop rdx\n"
                                 "ret\n");
}
...
ASSEMBLER_TEST_RUN(AddressingModes, test) {
  ...
  EXPECT_DISASSEMBLY("movq rax,[rsp]\n"
                     "movq rax,[rbp+0]\n"
                     "movq rax,[rax]\n"
                     "movq rax,[r10]\n"
                     "movq rax,[r12]\n"
...
ASSEMBLER_TEST_RUN(Testb2, test) {
  ...
  EXPECT_DISASSEMBLY("movl rax,0x........\n"
                     "bsrq rcx,rax\n"
                     "cmpq rcx,0x1f\n"
                     "jz 0x................\n"
                     "int3\n"
...
ASSEMBLER_TEST_RUN(JumpAddress, test) {
  ...
  EXPECT_DISASSEMBLY_NOT_WINDOWS("jmp [rdi+0x28]\n"
                                 "int3\n"
                                 "int3\n"
                                 "int3\n"
                                 "int3\n"
...
ASSEMBLER_TEST_RUN(DecrementLong, test) {
  ...
  EXPECT_DISASSEMBLY("movq rax,0x................\n"
                     "push rax\n"
                     "decq [rsp]\n"
                     "movq rcx,[rsp]\n"
                     "decq rcx\n"
...
ASSEMBLER_TEST_RUN(Negate, test) {
  ...
  EXPECT_DISASSEMBLY("movl rcx,0x2a\n"
                     "negq rcx\n"
                     "movq rax,rcx\n"
                     "ret\n");
}
...
ASSEMBLER_TEST_RUN(MoveExtend, test) {
  ...
  EXPECT_DISASSEMBLY("movl rdx,0x....\n"
                     "movzxbq rax,rdx\n"
                     "movsxwq r8,rdx\n"
                     "movzxwq rcx,rdx\n"
                     "addq r8,rcx\n"
...
ASSEMBLER_TEST_RUN(MoveExtendMemory, test) {
  ...
  EXPECT_DISASSEMBLY("movq rdx,0x................\n"
                     "push rdx\n"
                     "movzxbq rax,[rsp]\n"
                     "movsxwq r8,[rsp]\n"
                     "movzxwq rcx,[rsp]\n"
...
ASSEMBLER_TEST_RUN(MoveExtend32Memory, test) {
  typedef intptr_t (*MoveExtend)();
  EXPECT_EQ(0x7ffffffe, reinterpret_cast<MoveExtend>(test->entry())());
  EXPECT_DISASSEMBLY("movl r11,0x........\n"
                     "push r11\n"
                     "push 0x........\n"
                     "movsxdq rdx,[rsp+0x8]\n"
                     "movsxdq rax,[rsp]\n"
...
ASSEMBLER_TEST_RUN(MoveWord, test) {
  ...
  EXPECT_DISASSEMBLY("xorq rax,rax\n"
                     "push 0\n"
                     "movq rax,rsp\n"
                     "movq rcx,-1\n"
                     "movw [rax],rcx\n"
...
ASSEMBLER_TEST_RUN(LongAddReg, test) {
  ...
  EXPECT_EQ((a + b), res);
  EXPECT_DISASSEMBLY_NOT_WINDOWS("push rsi\n"
                                 "push rdi\n"
                                 "movl rax,[rsp]\n"
                                 "movl rdx,[rsp+0x4]\n"
                                 "movl rcx,[rsp+0x8]\n"
...
ASSEMBLER_TEST_RUN(AddReg, test) {
  ...
  EXPECT_DISASSEMBLY_NOT_WINDOWS("movq r10,rdi\n"
                                 "addq r10,rdx\n"
                                 "movq rax,rsi\n"
                                 "adcq rax,rcx\n"
                                 "ret\n");
...
ASSEMBLER_TEST_RUN(AddAddress, test) {
  ...
  EXPECT_EQ((ah + bh + 1), res);
  EXPECT_DISASSEMBLY_NOT_WINDOWS("push rcx\n"
                                 "push rdx\n"
                                 "push rsi\n"
                                 "push rdi\n"
                                 "movq r10,[rsp]\n"
...
ASSEMBLER_TEST_RUN(Bitwise, test) {
  ...
  EXPECT_DISASSEMBLY_NOT_WINDOWS("movq r10,-1\n"
                                 "orl [rdi],r10\n"
                                 "orl [rsi],r10\n"
                                 "movl rcx,0x2a\n"
                                 "xorl rcx,rcx\n"
...
ASSEMBLER_TEST_RUN(Bitwise64, test) {
  ...
  EXPECT_DISASSEMBLY("movl rax,0x2a\n"
                     "push rax\n"
                     "xorq rax,[rsp]\n"
                     "pop rcx\n"
                     "cmpq rax,0\n"
...
static int LeafReturn42() { return 42; }

static int LeafReturnArgument(int x) { return x + 87; }
...
ASSEMBLER_TEST_RUN(CallSimpleLeaf, test) {
  ...
  EXPECT_DISASSEMBLY_ENDS_WITH("call r11\n"
                               "addq rsp,8\n"
                               "ret\n");
}
...
ASSEMBLER_TEST_RUN(PackedDoubleAdd, test) {
  ...
  EXPECT_DISASSEMBLY_ENDS_WITH("movups xmm11,[rax]\n"
                               "addpd xmm10,xmm11\n"
                               "movaps xmm0,xmm10\n"
                               "ret\n");
}
...
ASSEMBLER_TEST_RUN(PackedDoubleNegate, test) {
  ...
  EXPECT_DISASSEMBLY_NOT_WINDOWS_ENDS_WITH("movups xmm10,[rax]\n"
                                           "movq r11,[thr+0x...]\n"
                                           "xorpd xmm10,[r11]\n"
                                           "movaps xmm0,xmm10\n"
                                           "pop thr\n"
...
ASSEMBLER_TEST_RUN(PackedDoubleSqrt, test) {
  ...
  EXPECT_FLOAT_EQ(4.0, res, 0.000001f);
  EXPECT_DISASSEMBLY_ENDS_WITH("movups xmm10,[rax]\n"
                               "sqrtpd xmm10,xmm10\n"
                               "movaps xmm0,xmm10\n"
                               "ret\n");
}
...
ASSEMBLER_TEST_RUN(PackedIntOperations2, test) {
  ...
  uint32_t res = reinterpret_cast<PackedIntOperationsCode>(test->entry())();
  EXPECT_EQ(static_cast<uword>(0x5), res);
  EXPECT_DISASSEMBLY_NOT_WINDOWS("subq rsp,0x20\n"
                                 "movups [rsp],xmm10\n"
...
ASSEMBLER_TEST_RUN(XmmAlu, test) {
  ...
  EXPECT_EQ(res, 0);
  EXPECT_DISASSEMBLY("addss xmm0,xmm0\n"
                     "addsd xmm0,xmm0\n"
                     "addps xmm0,xmm0\n"
                     "addpd xmm0,xmm0\n"
                     "cvtss2sd xmm0,xmm0\n"
...
ASSEMBLER_TEST_RUN(PackedNegate, test) {
  ...
  EXPECT_DISASSEMBLY_NOT_WINDOWS("push rbp\n"
                                 "movq rbp,rsp\n"
                                 "push r12\n"
                                 "push pp\n"
                                 "push thr\n"
...
ASSEMBLER_TEST_RUN(PackedLogicalOr, test) {
  ...
  EXPECT_DISASSEMBLY_ENDS_WITH("movups xmm1,[rax]\n"
                               "orps xmm0,xmm1\n"
                               "push rax\n"
                               "movss [rsp],xmm0\n"
                               "pop rax\n"
...
ASSEMBLER_TEST_RUN(PackedLogicalAnd, test) {
  ...
  EXPECT_DISASSEMBLY_ENDS_WITH("andps xmm0,[rax]\n"
                               "push rax\n"
                               "movss [rsp],xmm0\n"
                               "pop rax\n"
                               "ret\n");
...
ASSEMBLER_TEST_RUN(PackedLogicalNot, test) {
  ...
  EXPECT_EQ(static_cast<uword>(0x0), res);
  EXPECT_DISASSEMBLY_NOT_WINDOWS_ENDS_WITH("movups xmm9,[rax]\n"
                                           "movq r11,[thr+0x...]\n"
                                           "movups xmm0,[r11]\n"
                                           "xorps xmm0,xmm9\n"
                                           "push rax\n"
...
ASSEMBLER_TEST_RUN(Int32ToDoubleConversion, test) {
  ...
  EXPECT_DISASSEMBLY("movq r11,0x................\n"
                     "cvtsi2sd xmm0,r11\n"
                     "movq r11,0x................\n"
                     "cvtsi2sd xmm8,r11\n"
                     "subsd xmm0,xmm8\n"
...
ASSEMBLER_TEST_RUN(XorpdZeroing2, test) {
  ...
  EXPECT_FLOAT_EQ(0.0, res, 0.0001);
  EXPECT_DISASSEMBLY("xorpd xmm15,xmm15\n"
                     "xorpd xmm0,xmm0\n"
                     "xorpd xmm0,xmm15\n"
                     "comisd xmm0,xmm15\n"
                     "jz 0x................\n"
...
ASSEMBLER_TEST_RUN(Pxor, test) {
  ...
  EXPECT_DISASSEMBLY("pxor xmm0,xmm0\n"
                     "ret\n");
}
...
ASSEMBLER_TEST_RUN(SquareRootDouble, test) {
  ...
  EXPECT_DISASSEMBLY("sqrtsd xmm0,xmm0\n"
                     "ret\n");
}
...
ASSEMBLER_TEST_RUN(DoubleToDoubleTrunc, test) {
  ...
  res = reinterpret_cast<DoubleToDoubleTruncCode>(test->entry())(-12.8);
  EXPECT_EQ(-12.0, res);
  EXPECT_DISASSEMBLY("roundsd rax, rax, 3\n"
                     "ret\n");
}
...
ASSEMBLER_TEST_RUN(ExtractSignBits, test) {
  ...
  EXPECT_EQ(1, res);
  EXPECT_DISASSEMBLY("movmskpd rax,xmm0\n"
                     "andl rax,1\n"
                     "ret\n");
}
...
ASSEMBLER_TEST_RUN(ConditionalMovesCompare, test) {
  ...
  EXPECT_DISASSEMBLY_ENDS_WITH("movl rdx,1\n"
                               "movq rcx,-1\n"
                               "cmovlq rax,rcx\n"
                               "cmovgeq rax,rdx\n"
                               "ret\n");
...
ASSEMBLER_TEST_RUN(BitTestImmediate, test) {
  ...
  EXPECT_DISASSEMBLY("movl r11,0x20\n"
                     "bt r11,5\n"
                     "jc 0x................\n"
                     "int3\n"
                     "movl rax,1\n"
...
ASSEMBLER_TEST_RUN(ConditionalMovesEqual, test) {
  ...
  EXPECT_EQ(0, res);
  EXPECT_DISASSEMBLY_ENDS_WITH("xorq rax,rax\n"
                               "movl rcx,1\n"
                               "cmpq rdx,0x...\n"
                               "cmovzq rax,rcx\n"
                               "ret\n");
...
ASSEMBLER_TEST_RUN(ConditionalMovesNoOverflow, test) {
  ...
  EXPECT_EQ(0, res);
  EXPECT_DISASSEMBLY_NOT_WINDOWS("movq rdx,rdi\n"
                                 "addq rdx,rsi\n"
                                 "movl rax,1\n"
                                 "movl rcx,0\n"
                                 "cmovnoq rax,rcx\n"
...
IMMEDIATE_TEST(AddrImmRAX, RAX, 0xffffffff, __ pushq(RAX), Address(RSP, 0),
               __ popq(RAX))
IMMEDIATE_TEST(AddrImmRAXByte, RAX, 0x7f, __ pushq(RAX), Address(RSP, 0),
               __ popq(RAX))
